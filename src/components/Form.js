  ...
  return (
    <>
      ...
      <form id='add-task-form' className='add-task-form' onSubmit={check}>
        ...
        <input id='add-task-input' className='add-task-input' name='title' maxLength='40' 
                placeholder='Create a new todo...' value={state} onChange={handleChange}/>
